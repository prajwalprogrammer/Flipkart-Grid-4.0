...
export default function MyListedItems({ marketplace, nft, account }) {
  ...
  return (
    <div className="MyListedItem">
        <h2 className='myListedItemTitle'>Listed</h2>
            ...
            {listedItems.map((item, idx) => (
              ...
              <img src={item.image} className="NFTboxImg"/>
                <div className="NFTboxContent">
                  ...
                  <h1 className="NFTcardContent">{ethers.utils.formatEther(item.totalPrice)} ETH</h1>
                  <h1 className="NFTcardStatusNotActive">{ethers.utils.formatEther(item.totalPrice)} ETH</h1>
